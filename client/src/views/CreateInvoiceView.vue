...
const { pending, errors, handlerOnSubmit } = useForm("Invoices", false, true)
        ...
        <div class="mx-auto mt-12 w-full md:w-[80%] lg:w-[60%] box-border">
            <form action="/api/invoice" method="post" @submit="handlerOnSubmit">
                ...
                <div class="w-full mb-6">
                    ...
                    <ErrorMessageComponent :message="typeof errors?.code != 'undefined' ? errors.code[0] : ''" />
                </div>
                <div class="my-4">
                    <LabelComponent :for="'date'" :label="'Data emissione'" />
                </div>
                <div class="w-full mb-6">
                    <InputComponent :id="'date'" :name="'date'" :type="'date'" :required="false" />
                    <ErrorMessageComponent :message="typeof errors?.date != 'undefined' ? errors.date[0] : ''" />
                </div>
                <div class="my-4">
                    <LabelComponent :for="'amount'" :label="'Importo'" />
                </div>
                <div class="w-full mb-6">
                    <InputComponent :id="'amount'" :name="'amount'" :type="'text'" :required="false" />
                    <ErrorMessageComponent :message="typeof errors?.amount != 'undefined' ? errors.amount[0] : ''" />
                </div>
                <div class="my-4">
                ...
                <div class="w-full mb-6">
                    ...
                    <ErrorMessageComponent :message="typeof errors?.company != 'undefined' ? errors.company[0] : ''" />
                </div>
